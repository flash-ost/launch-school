...
"""
# By using self.__class__.__name__: we reference __class__ attribute of the current instance (self)
# and then reference __name__ attribute of the referenced class
class SpeedMixin:
    def go_fast(self):
        print(f'I am a super fast {self.__class__.__name__}!')
