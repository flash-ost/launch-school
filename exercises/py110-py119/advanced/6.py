...
"""
## Understanding
# Input: sorted list of data of the same type, search item
# Output: search item index if present in list, else -1

# Use binary search

## Algorithm
# Initialize start to 0
# Initialize end to length of list
# Repeat while start < end:
#   mid = start + end // 2
#   if midth element is equal to search item:
#       return mid
#   if midth element is greater than search item:
#       set end to mid - 1
#       continue
#   else:
#       set start to mid + 1
