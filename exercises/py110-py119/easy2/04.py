...
## Understanding
# Input: unordered list with exactly 1 value duplicated
# Output: value that is duplicated

# Explicit rules:
# Input list will always have a duplicate value
...
## Data Structure
# we will work with original list

## Algorithm
# Iterate over list elements:
#   Calculate each elements' num of occurances
#   return element if its' number of occurances > 1
