...
## Understanding
# Input: integer
# Output: boolean signifying whether a given number is prime or not

# Prime number is only evenly divisible by itsef and 1

## Algorithm
# If number is 1 return False
# Create a var result and set it to True
# Iterate over range from 2 to number
#   if division of input number by current num in range has no remainder:
#       return False
# Return True
